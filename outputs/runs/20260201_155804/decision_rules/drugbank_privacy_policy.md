# drugbank_privacy_policy — Risk Report
...
- **advertising / ad sharing** / TARGETED_ADS — `0a534ccfacfdbd04` (What personal data we collect): Should you provide consent to marketing and profiling cookies being installed on your device... our advertising partners may also use such technologies to collect limited information about your device and interactions.
...
- **COLLECTS_DEVICE_USAGE**: `supported` — Yes, the policy states it collects device identifiers and usage data.
...
- **OPT_OUT_SHARING**: `conflicting` — Yes, the policy provides an opt-out option, but also states that DrugBank does not sell or rent personal information.
